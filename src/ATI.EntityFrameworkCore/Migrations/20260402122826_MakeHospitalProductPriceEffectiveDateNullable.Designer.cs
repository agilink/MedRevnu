...
namespace ATI.Migrations
{
    ...
    [Migration("20260402122826_MakeHospitalProductPriceEffectiveDateNullable")]
    partial class MakeHospitalProductPriceEffectiveDateNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ATI.Admin.Domain.Entities.CompanyType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ATI.Admin.Domain.Entities.Personnel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FIRST_NAME_PROPER")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("NUMBER_HOME")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("NUMBER_MOBILE")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("ATI.Admin.Domain.Entities.UserCompany", b =>
                {
                    ...
                    b.ToTable("UserCompany", "ADM");
                });

            modelBuilder.Entity("ATI.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ATI.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ATI.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ATI.Revenue.Domain.Entities.HospitalProductPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HospitalId", "ProductId", "EffectiveDate");

                    b.ToTable("HospitalProductPrice", "REV");
                });

            modelBuilder.Entity("ATI.Revenue.Domain.Entities.ProcedureQuota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcedureQuota", "REV");
                });

            modelBuilder.Entity("ATI.Revenue.Domain.Entities.ProcedureTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcedureTransaction", "REV");
                });

            modelBuilder.Entity("ATI.Revenue.Domain.Entities.ProcedureType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ATI.Revenue.Domain.Entities.ProductQuota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HospitalId", "ProductCategoryId", "PeriodMonth", "PeriodYear");

                    b.ToTable("ProductQuota", "REV");
                });

            modelBuilder.Entity("ATI.Revenue.Domain.Entities.ProductSubcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductSubcategory", "REV");
                });
            ...
            modelBuilder.Entity("ATI.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.HasOne("ATI.MultiTenancy.Payments.SubscriptionPayment", null)
            ...
            modelBuilder.Entity("ATI.Revenue.Domain.Entities.Case", b =>
                {
                    b.HasOne("ATI.Revenue.Domain.Entities.ProcedureType", "ProcedureType")
                        .WithMany("Cases")
            ...
            modelBuilder.Entity("ATI.Revenue.Domain.Entities.HospitalProductPrice", b =>
                {
                    b.HasOne("ATI.Admin.Domain.Entities.Facility", "Hospital")
                        .WithMany()
            ...
            modelBuilder.Entity("ATI.Revenue.Domain.Entities.ProcedureTransaction", b =>
                {
                    ...
                    b.HasOne("ATI.Admin.Domain.Entities.Personnel", "Physician")
                        .WithMany()
            ...
            modelBuilder.Entity("ATI.Revenue.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ATI.Revenue.Domain.Entities.ProductSubcategory", "ProductSubcategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ATI.Authorization.Roles.Role", null)
                        .WithMany("Claims")

...
namespace ATI.Migrations
{
    ...
    partial class ATIDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ATI.OpenIddict.Applications.OpenIddictApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ATI.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ATI.OpenIddict.Scopes.OpenIddictScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ATI.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ATI.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.HasOne("ATI.OpenIddict.Applications.OpenIddictApplication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ATI.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    ...
                    b.HasOne("ATI.OpenIddict.Authorizations.OpenIddictAuthorization", null)
                        .WithMany()

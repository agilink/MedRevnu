...
using ATI.EntityFrameworkCore.Repositories;

namespace ATI.Organizations
{
    public class UserOrganizationUnitRepository : ATIRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<ATIDbContext> dbContextProvider)

...
{
    public class SubscriptionPaymentRepository : ATIRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ATIDbContext> dbContextProvider)

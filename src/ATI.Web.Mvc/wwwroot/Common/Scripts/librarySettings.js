(function () {
  ...
  if (abp.libs.sweetAlert) {
    ...
    abp.libs.sweetAlert.config.confirm.confirmButtonText = abp.localization.localize('Yes', 'ATI');
    abp.libs.sweetAlert.config.confirm.cancelButtonText = abp.localization.localize('Cancel', 'ATI');

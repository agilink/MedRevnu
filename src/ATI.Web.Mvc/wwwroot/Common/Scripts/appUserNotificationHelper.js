...
(function ($) {
  app.UserNotificationHelper = (function () {
    return function () {
      ...
      /* Example:
            abp.notifications.messageFormatters['ATI.MyNotificationDataType'] = function(userNotification) {
      ...
      function getUrl(userNotification) {
        switch (userNotification.notification.notificationName) {
          case 'App.NewUserRegistered':
            return '/Core/users?filterText=' + userNotification.notification.data.properties.emailAddress;
          case 'App.NewTenantRegistered':
            return '/Core/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
      ...
      var openSettingsModal = function () {
        new app.ModalManager({
          viewUrl: abp.appPath + 'Core/Notifications/SettingsModal',
          scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Notifications/_SettingsModal.js',

(function () {
  ...
  app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'Core/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/Core/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',

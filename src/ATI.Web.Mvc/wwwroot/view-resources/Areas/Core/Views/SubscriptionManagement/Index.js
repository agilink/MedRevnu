(function () {
    $(function () {
        ...
        const _editPersonModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Core/SubscriptionManagement/ShowDetailModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/SubscriptionManagement/_ShowDetailModal.js',
        ...
        function createOrShowInvoice(data) {
            ...
            if (invoiceNo) {
                window.open('/Core/Invoice?paymentId=' + paymentId, '_blank');
            } else {
                _invoiceService
                    .createInvoice({

(function ($) {
    app.modals.CreateMassNotificationModal = function () {
        ...
        var _userLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Core/Notifications/UserLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Notifications/_UserLookupTableModal.js',
            modalClass: 'UserLookupTableModal',
        });

        var _organizationUnitLookupTableModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Core/Notifications/OrganizationUnitLookupTableModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Notifications/_OrganizationUnitLookupTableModal.js',
        ...
        $('#CreateMassNotificationModal_TargetNotifiers').change(function () {
            ...
            var isSMSSelected = selectedTargetNotifiers.indexOf("ATI.Notifications.SmsRealTimeNotifier") >= 0;

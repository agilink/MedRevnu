...
(function () {
    $(function () {
        ...
        var _createMassNotificationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Core/Notifications/CreateMassNotificationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Notifications/_CreateMassNotificationModal.js',

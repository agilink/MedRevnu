  ...
  app.modals.MySettingsModal = function () {
    ...
    this.init = function (modalManager) {
      ...
      let twoFactorModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Core/Profile/TwoFactorAuthenticationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_TwoFactorAuthenticationModal.min.js',
      ...
      var viewRecoveryCodesModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Core/Profile/ViewRecoveryCodesModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_ViewRecoveryCodesModal.min.js',
      ...
      var removeAuthenticatorModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Core/Profile/RemoveAuthenticatorModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_RemoveAuthenticatorModal.min.js',
      ...
      var smsVerificationModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Core/Profile/SmsVerificationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_SmsVerificationModal.min.js',

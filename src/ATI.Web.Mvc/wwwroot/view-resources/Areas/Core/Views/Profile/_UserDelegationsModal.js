(function ($) {
  app.modals.UserDelegationsModal = function () {
    ...
    var _createNewUserDelegationModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Profile/CreateNewUserDelegationModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_CreateNewUserDelegationModal.min.js',

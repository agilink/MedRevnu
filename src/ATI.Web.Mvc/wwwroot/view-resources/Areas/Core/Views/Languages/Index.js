(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Languages/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Languages/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  document.location.href = abp.appPath + 'Core/Languages/Texts?languageName=' + data.record.name;
                },
              },
              {

$(function () {
  ...
  var _addWidgetModal = new app.ModalManager({
    viewUrl: abp.appPath + 'Core/' + $('#DashboardName').val() + '/AddWidgetModal',
    scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/CustomizableDashboard/_AddWidgetModal.js',

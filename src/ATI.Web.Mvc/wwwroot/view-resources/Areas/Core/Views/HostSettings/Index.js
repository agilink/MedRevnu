      ...
      _hostSettingsService
        .updateAllSettings({
          ...
          tenantManagement: {
              ...
              captchaSettings: {
                  useCaptchaOnRegistration: $('#Setting_UseCaptchaOnRegistration').val(),
                  useCaptchaOnResetPassword: $('#Setting_UseCaptchaOnResetPassword').val(),
                  useCaptchaOnEmailActivation: $('#UseCaptchaOnEmailActivation').val(),
              },
          },

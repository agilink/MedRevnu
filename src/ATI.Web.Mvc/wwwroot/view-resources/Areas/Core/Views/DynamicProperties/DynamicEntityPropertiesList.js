(function () {
  $(function () {
    ...
    var _selectAnEntity = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/DynamicProperty/SelectAnEntityModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/DynamicProperties/_SelectAnEntityModal.js',
    ...
    var _manageDynamicEntityPropertyModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/DynamicEntityProperty/ManageModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/Core/Views/_Bundles/dynamic-entity-properties-manage-modal.min.js',

(function () {
  app.modals.InactivityControllerNotifyModal = function () {
    ...
    function getExternalLoginProviderTypeName(userId, callback) {
      abp.services.app.userLogin
        .getExternalLoginProviderNameByUser(userId)
        .done(function (providerName) {
          if (typeof callback === 'function') {
  ...
  app.modals.InactivityControllerNotifyModal.create = function () {
    var modal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Common/InactivityControllerNotifyModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/Core/Views/Common/Modals/_InactivityControllerNotifyModal.js',

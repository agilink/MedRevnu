var DynamicEntityPropertyManager = (function () {
  return function () {
    ...
    let _dynamicPropertiesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/Core/Views/_Bundles/manage-dynamic-entity-property-values-modal.min.js',

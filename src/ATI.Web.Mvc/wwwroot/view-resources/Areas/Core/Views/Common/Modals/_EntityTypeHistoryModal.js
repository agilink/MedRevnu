(function () {
  app.modals.EntityTypeHistoryModal = function () {
    ...
    function showEntityChangeDetails(entityChange) {
      var entityChangeDetailModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Core/AuditLogs/EntityChangeDetailModal',
  ...
  app.modals.EntityTypeHistoryModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Common/EntityTypeHistoryModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Common/Modals/_EntityTypeHistoryModal.js',

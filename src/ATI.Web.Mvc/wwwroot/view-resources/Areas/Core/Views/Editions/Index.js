(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Editions/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Editions/_CreateModal.js',
      modalClass: 'CreateEditionModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Editions/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Editions/_EditModal.js',
      modalClass: 'EditEditionModal',
    });

    var _moveTenantsToAnotherEditionModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Editions/MoveTenantsToAnotherEdition',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Editions/_MoveTenantsToAnotherEditionModal.js',

(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/OrganizationUnits/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/OrganizationUnits/_CreateModal.js',
      modalClass: 'CreateOrganizationUnitModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/OrganizationUnits/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/OrganizationUnits/_EditModal.js',
      modalClass: 'EditOrganizationUnitModal',
    });

    var _addUserModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/OrganizationUnits/AddMemberModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/OrganizationUnits/_AddMemberModal.js',
    ...
    var _addRoleModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/OrganizationUnits/AddRoleModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/OrganizationUnits/_AddRoleModal.js',
      ...
      contextMenu: function (node) {
        ...
        if (entityHistoryIsEnabled() && _permissions.history) {
          items.history = {
            ...
            _disabled: !_permissions.manageOrganizationTree,
            action: function () {
                window.location.href = abp.appPath + `Core/EntityChanges/${node.original.id}/${_entityTypeFullName}`;
            },
          };
        }

(function () {
    $(function () {
        ...
        var _userPermissionsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Core/Users/PermissionsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Users/_PermissionsModal.js',
            modalClass: 'UserPermissionsModal',
        });

        var _excelExportModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Core/Users/ExcelExportModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Users/_ExcelExportModal.js',
                            ...
                            },
                            {
                                ...
                                visible: function () {
                                    return _dynamicEntityPropertyManager.canShow(
                                        'ATI.Authorization.Users.User'
                                    );
                                },
                                action: function (data) {
                                    _dynamicEntityPropertyManager.modal.open({
                                        entityFullName: 'ATI.Authorization.Users.User',
        ...
        var url = abp.appPath + 'Core/Users/ImportFromExcel';

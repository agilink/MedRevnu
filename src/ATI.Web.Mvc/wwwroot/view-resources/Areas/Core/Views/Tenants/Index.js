(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'ATI.MultiTenancy.Tenant';
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Tenants/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Tenants/_CreateModal.js',
      modalClass: 'CreateTenantModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Tenants/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Tenants/_EditModal.js',
      modalClass: 'EditTenantModal',
    });

    var _featuresModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Tenants/FeaturesModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Tenants/_FeaturesModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                    window.location.href = abp.appPath + `Core/EntityChanges/${data.record.id}/${_entityTypeFullName}`;
                },
              },
            ],
          },

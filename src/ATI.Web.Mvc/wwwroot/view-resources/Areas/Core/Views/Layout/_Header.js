(function ($) {
  $(function () {
    ...
    var mySettingsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Profile/MySettingsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_MySettingsModal.min.js',
    ...
    var changePasswordModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Profile/ChangePasswordModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_ChangePasswordModal.min.js',
    ...
    var changeProfilePictureModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Profile/ChangePictureModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_ChangePictureModal.min.js',
    ...
    var manageLinkedAccountsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Profile/LinkedAccountsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_LinkedAccountsModal.min.js',
    ...
    var userDelegationsModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Profile/UserDelegationsModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Profile/_UserDelegationsModal.min.js',

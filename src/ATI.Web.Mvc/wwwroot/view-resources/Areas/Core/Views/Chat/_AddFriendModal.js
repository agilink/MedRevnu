(function () {
    let _addFromDifferentTenantModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Core/Chat/AddFromDifferentTenantModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Chat/_AddFromDifferentTenantModal.js',
    ...
    app.modals.AddFriendModal.create = function (lookupOptions) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Core/Chat/AddFriendModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Chat/_AddFriendModal.js',

(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'ATI.Authorization.Roles.Role';
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'Core/Roles/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/Core/Views/Roles/_CreateOrEditModal.js',

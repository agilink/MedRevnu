...
namespace ATI.Web.Areas.Core.Views.Shared.Components.CoreMenu
{
    public class CoreMenuViewComponent : ATIViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public CoreMenuViewComponent(
            ...
            string topMenuClass = "menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0")
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(CoreNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
                Height = height,
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, CorePageNames.Tenant.SubscriptionManagement);

...
namespace ATI.Web.Areas.Core.Views.Shared.Components.CoreUserMenu
{
    public class CoreUserMenuViewComponent : ATIViewComponent
    {
        private readonly IMultiTenancyConfig _multiTenancyConfig;
        private readonly IAbpSession _abpSession;
        private readonly IPerRequestSessionCache _sessionCache;

        public CoreUserMenuViewComponent(

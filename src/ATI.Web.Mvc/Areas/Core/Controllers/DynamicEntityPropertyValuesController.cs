...
using ATI.Web.Areas.Core.Models.DynamicEntityPropertyValues;
...
namespace ATI.Web.Areas.Core.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : ATIControllerBase
    {
        ...
        [HttpGet("/Core/DynamicEntityPropertyValue/ManageAll/{entityFullName}/{entityId}")]

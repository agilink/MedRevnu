...
using ATI.DashboardCustomization.Dto;
using ATI.Web.Areas.Core.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : ATIControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
                ...
                {
                    Application = ATIDashboardCustomizationConsts.Applications.Mvc,
                    PageId = pageId,
            ...
            return PartialView(
                "~/Areas/Core/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml",
                viewModel
            );
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            ...
            return View("~/Areas/Core/Views/Shared/Components/CustomizableDashboard/Index.cshtml",

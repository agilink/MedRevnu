...
using ATI.Identity;
using ATI.Schemas;
using ATI.Web.Chat.SignalR;
using ATI.Web.Common;
using ATI.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using ATI.Web.Swagger;
using Stripe;
...
using ATI.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using ATI.Web.Authentication.PasswordlessLogin;
using ATI.Web.Extensions;
using ATI.Web.MultiTenancy;
using ATI.Web.OpenIddict;
using SecurityStampValidatorCallback = ATI.Identity.SecurityStampValidatorCallback;
...
namespace ATI.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<ATIWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "ATI API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("ATI.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "ATI API", Version = "v1"});
                ...
                var applicationXml = $"ATI.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"ATI.Web.Core.xml";

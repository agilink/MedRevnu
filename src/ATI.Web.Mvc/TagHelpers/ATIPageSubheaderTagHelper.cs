...
namespace ATI.Web.TagHelpers
{
    ...
    public class ATIPageSubheaderTagHelper : TagHelper
    {
        ...
        public ATIPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {

...
using ATI.Web.Models.TenantRegistration;

namespace ATI.Web.Controllers
{
    public class TenantRegistrationController : ATIControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new {area = "Core"}));
                    }
        ...
        public async Task<IActionResult> BuyNowSucceed(long paymentId)
        {
            ...
            return RedirectToAction("Index", "SubscriptionManagement", new {area = "Core"});
        }

...
using ATI.Core.Base;
using ATI.Core.Extensions;
using ATI.Dto;
using ATI.Types;

namespace ATI.Queries
{
    public class OrganizationUnitQuery : ATIQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {

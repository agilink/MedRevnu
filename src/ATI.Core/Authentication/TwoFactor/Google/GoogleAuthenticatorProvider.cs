...
namespace ATI.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ATIServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ATI", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);

...
/// </summary>
public class ATISimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public ATISimplePermissionDependency()
    {
    ...
    public ATISimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public ATISimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {

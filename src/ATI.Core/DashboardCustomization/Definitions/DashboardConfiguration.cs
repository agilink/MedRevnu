...
using ATI.DashboardCustomization.Definitions.Cache;

namespace ATI.DashboardCustomization.Definitions
{
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var dateRangeFilter = new WidgetFilterDefinition(
                ATIDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            var simplePermissionDependencyForTenantDashboard =
                new ATISimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);

            var dailySales = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                "WidgetDailySales",
            ...
            var generalStats = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new ATISimplePermissionDependency(
                    requiresAll: true,
            ...
            var profitShare = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                "WidgetProfitShare",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var memberActivity = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            var regionalStats = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                "WidgetRegionalStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var salesSummary = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                "WidgetSalesSummary",
                usedWidgetFilters: new List<string>() {dateRangeFilter.Id},
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            ...
            var topStats = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var simplePermissionDependencyForHostDashboard =
                new ATISimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);

            var incomeStatistics = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            var hostTopStats = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Host.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Host,
                permissionDependency: simplePermissionDependencyForHostDashboard
            );
            ...
            var editionStatistics = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            var subscriptionExpiringTenants = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            var recentTenants = new WidgetDefinition(
                ATIDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                "WidgetRecentTenants",
                side: MultiTenancySides.Host,
                usedWidgetFilters: new List<string>() {dateRangeFilter.Id},
                permissionDependency: simplePermissionDependencyForHostDashboard
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                ATIDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                ATIDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,

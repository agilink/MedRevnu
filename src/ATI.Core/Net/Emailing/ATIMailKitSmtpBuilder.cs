...
{
    public class ATIMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public ATIMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(ATIConsts.LocalizationSourceName, name);
        }

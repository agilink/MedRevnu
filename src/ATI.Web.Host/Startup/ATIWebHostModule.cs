...
using ATI.Web.Startup.ExternalLoginInfoProviders;
...
namespace ATI.Web.Startup
{
    ...
    public class ATIWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ATIWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ATIWebHostModule).GetAssembly());
        }

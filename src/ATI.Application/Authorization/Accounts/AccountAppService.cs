...
namespace ATI.Authorization.Accounts
{
    public class AccountAppService : ATIAppServiceBase, IAccountAppService
    {
        ...
        private async Task SendSmsPasswordlessCode(string phoneNumber)
        {
            ...
            var message = string.Format(L("PasswordlessLogin_SmsMessage", ATIConsts.ProductName, code));

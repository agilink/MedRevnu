...
namespace ATI.DataExporting.Excel.MiniExcel
{
    public abstract class MiniExcelExcelImporterBase<TEntity>(ILocalizationManager localizationManager)
    {
        private readonly ILocalizationSource _localizationSource = localizationManager.GetSource(ATIConsts.LocalizationSourceName);

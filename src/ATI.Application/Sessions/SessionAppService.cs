...
{
    public class SessionAppService : ATIAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ATIConsts.Currency,
                        CurrencySign = ATIConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ATIConsts.AllowTenantsToChangeEmailSettings,

...
using EntityHistoryHelper = ATI.EntityHistory.EntityHistoryHelper;

namespace ATI.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ATIAppServiceBase, IAuditLogAppService
    {

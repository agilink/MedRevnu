...
using ATI.Authentication.TwoFactor;
using ATI.Chat;
using ATI.Configuration;
using ATI.EntityFrameworkCore;
using ATI.Startup;
using ATI.Web.Authentication.JwtBearer;
using ATI.Web.Authentication.TwoFactor;
using ATI.Web.Chat.SignalR;
using ATI.Web.Common;
using ATI.Web.Configuration;
using ATI.Web.DashboardCustomization;
...
namespace ATI.Web
{
    ...
    public class ATIWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ATIWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                ATIConsts.ConnectionStringName
            );
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ATIApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ATIWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ATIWebCoreModule).Assembly);
        }

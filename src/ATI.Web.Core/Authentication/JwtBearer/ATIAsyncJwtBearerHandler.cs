...
namespace ATI.Web.Authentication.JwtBearer
{
    public class ATIAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public ATIAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,

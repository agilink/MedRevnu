...
namespace ATI.Web.Public.Startup
{
    [DependsOn(
        typeof(ATIWebCoreModule)
    )]
    public class ATIWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ATIWebFrontEndModule(IWebHostEnvironment env, ATIEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ATIWebFrontEndModule).GetAssembly());
        }
    }
}

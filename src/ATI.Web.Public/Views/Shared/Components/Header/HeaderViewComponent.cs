...
using ATI.Url;
using ATI.Web.Public.Startup;
using ATI.Web.Session;
using ATI.Web.UiCustomization;

namespace ATI.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ATIViewComponent
    {

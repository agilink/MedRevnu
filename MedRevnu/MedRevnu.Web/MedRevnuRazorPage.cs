...
{
    public abstract class MedRevnuRazorPage<TModel> : AbpRazorPage<TModel>
    {
        ...
        protected MedRevnuRazorPage()
        {
            //LocalizationSourceName = PhillipsConsts.LocalizationSourceName;
        }

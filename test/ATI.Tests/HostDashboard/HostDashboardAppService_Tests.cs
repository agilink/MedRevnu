...
using ATI.MultiTenancy.HostDashboard;
...
namespace ATI.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ATIDbContext context, SubscriptionPayment subscriptionPayment)
        {
